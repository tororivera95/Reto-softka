...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2021 a las 18:43:50
...
(2, '2021-10-05', 12344, 2, 2),
(3, '2021-10-05', 67890, 2, 2),
(4, '2021-10-05', 67890, 1, 1),
(5, '2021-10-05', 54321, 2, 2);
...
(12344, 'Federico', 'Florez', 20, 'NO'),
(12345, 'Javier', 'Lopez', 25, 'NA'),
(54321, 'Laura', 'Ocampo', 45, 'NO'),
(67890, 'Pedro', 'Gonzales', 56, 'NO');
...
(17, '¿Quién lideró la rebelión de esclavos en Cartagena en 1599?', 2, 4),
...
--
ALTER TABLE `acumulado`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id del acumulado', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `juego`
--
ALTER TABLE `juego`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id del juego', AUTO_INCREMENT=6;
